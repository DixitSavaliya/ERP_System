                                                ...
                                                <div>
                                                    {
                                                        this.state.isDisplay == true ? (
                                                            <Row>
                                                                <Col className={(checkRights('application', 'write') == true) || (checkRights('application', 'delete') == true) ? 'cols col-sm-12 col-md-3 col-lg-3 col-xl-3' : 'cols col-sm-12'}>
                                                                ...
                                                                <Col className={(checkRights('application', 'write') == true) || (checkRights('application', 'delete') == true) ? 'cols col-sm-12 col-md-9 col-lg-9 col-xl-9' : 'cols col-sm-12'}>
                                                                    {
                                                                        this.props.auth.auth_data.user_group == "publisher" ? (
