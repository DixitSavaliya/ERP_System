...
class DocumentListContainer extends Component {
    ...
    //   this.id = this.props.location.pathname.split('/')[2];
      return (
        <DocumentList auth={auth} {...this.props} countuser={countuser} usersPGData={usersPGData} searchUsersData={searchUsersData} blockUser={blockUser}/>
      );
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(DocumentListContainer));